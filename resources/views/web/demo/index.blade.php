                                ...
                                <div class="feature-item px-2 py-3 mb-3 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="feature-item-content col-10 d-flex flex-column justify-content-center">
                                            ...
                                            <p class="text-muted m-0">manage day to day activity with almost all features.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item px-2 py-3 mb-3 wow fadeInUp" data-wow-delay="0.7s">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="feature-item-content col-10 d-flex flex-column justify-content-center">
                                            ...
                                            <p class="text-muted m-0">Manage OPD appointments, visitors, postal & complain.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="feature-item px-2 py-3 mb-3 wow fadeInUp" data-wow-delay="0.8s">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="feature-item-content col-10 d-flex flex-column justify-content-center">
                                            ...
                                            <p class="text-muted m-0">Manage OPD, IPD, different departments billing &
                                                payroll.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 all-btns my-5">
                        <div class="row">
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn superadmin-login">superadmin login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn admin-login">admin login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn doctor-login">doctor login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn accountant-login">accountant login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn receptionist-login">receptionist login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn pharmacist-login">pharmacist login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn pathology-login">phathologist login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn radiologist-login">radiologist login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn patient-login">patient login</a>
                            </div>
                            <div class="col-md-4 col-lg-3 mb-4 col-6">
                                <a href="javascript:void(0)" class="btn front-site">front site</a>
                            </div>
                        </div>
                    </div>
                </div>
